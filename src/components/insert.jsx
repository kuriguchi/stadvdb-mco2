            ...
            <div className="flex w-full h-full bg-slate-200 p-10">
                ...
                <div className="absolute w-full h-full top-0 left-0 right-0 mx-auto z-0 opacity-80 pointer-events-none">   
                    <div className="w-full h-full relative select-none">
                        <Image src={"/insert_bg.jpg"} alt={""} fill priority />
                    </div>
                </div>
                ...
                <div className="w-3/4 lg:w-1/2 mx-auto bg-white z-10 bg-opacity-90 rounded-xl p-10 overflow-auto">
                    ...
                    >
                        ...
                        <button className={`${montserrat.className} flex w-full sm:w-1/2 md:w-1/4 px-5 py-2 text-[16px] text-white bg-sky-500 hover:brightness-75 ml-auto rounded-[20px] `}>
                            <p className="my-auto w-full text-left">Add Entry</p>
